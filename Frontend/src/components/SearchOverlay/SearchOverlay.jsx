...
const SearchOverlay = ({ open, onClose }) => {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(async () => {
      ...
      try {
        const response = await getSearchSuggestionsApi(query.trim());
          ...
          <div className="search-overlay__inner">
            ...
            <form onSubmit={submit} className="search-overlay__form">
              ...
              <input
                ...
                placeholder="Search pieces, categories, brands..."
            ...
            <div className="search-overlay__suggestions">
              ...
              {query && !suggestions.length && (
                <p className="search-overlay__empty">No matching pieces yet.</p>
              )}
            </div>
          </div>
        </motion.div>
